...
| **INJ 1** | **PB15** | GPIO (moved off PB4 for Cam2) |
| **INJ 2–4** | PB5–PB7 | GPIO / TIM3/4 |
| **Boost** | PB8 | TIM4_CH3 |
...
## INJ1 / Cam2 pin move (STRIX V2)

| Function | Old | New | Resource |
|----------|-----|-----|----------|
| **Injector 1** | PB4 | **PB15** | GPIO output |
| **Cam 2** | — | **PB4** | TIM3_CH1 input capture |

PB4 is TIM3_CH1 (AF2). SYS Debug must be **Serial Wire only** so PB4 is not NJTRST.

Wire the injector 1 low-side driver to **PB15**.
